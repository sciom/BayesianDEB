...
# Install BayesianDEB
# devtools::install_local("path/to/BayesianDEB")
```
...
BayesianDEB follows the BDEB book (Ch. 6) recommendations:
...
- BDEB Book, Ch. 4-8: Mathematical formulation
- BDEB Book, Ch. 14: Stan implementation details
- BDEB Book, Ch. 16: R workflows
- BDEB Book, Ch. 20-21: Eisenia and Folsomia case studies
